...
export default function BuscarFruta({navigation}){
    ...
    return(
        <View style={styles.container}>
            ...
            <Text style={styles.subtitle}>Digite o nome de uma fruta para pesquisar.</Text>
            <TextInput
            ...
            <FlatList
                data={frutas}
                renderItem={({item}) => <Text style={styles.result}>Fruta: {item.Fruta}, preço: {item.Preco}</Text>}
